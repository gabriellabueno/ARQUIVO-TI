...
&#xNAN;_&#x45;ncadeamento:_ Informação é armazenada em estruturas encadeadas; tabela armazena ponteiros para uma lista ligada de elementos com mesmo endereço\
&#xNAN;_&#x45;ndereçamento Aberto:_ Informação é armazenada na própria tabela hash, sem utilização de ponteiros; redução no consumo de memória
