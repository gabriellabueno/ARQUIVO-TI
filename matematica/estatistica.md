...
&#xNAN;_&#x61;rredondar p/ +_\
$$h_i = L_i-l_i$$

**Amplitude Total**$$(AT)$$\
&#xNAN;_&#x64;elta entre maior e menor valor da amostra_\
$$AT = L(max) - l(min)$$

**Amplitude Amostral** $$(AA)$$\
&#xNAN;_&#x64;elta entre maior e menor valor das classes_\
$$AT = x(max) - x(min)$$
...
**a) Sem intervalo de classe**\
&#xNAN;_&#x4D;o = elemento que apresenta maior frequência_
